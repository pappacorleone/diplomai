...
var StreamingAvatar = /** @class */ (function () {
                ...
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        this.mediaStreamAudioSource =
                            (_a = this.audioContext) === null || _a === void 0 ? void 0 : _a.createMediaStreamSource(devicesStream);
    ...
    StreamingAvatar.prototype.speak = function (requestData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                if (this.webSocket &&
                    this.audioRawFrame &&
                    requestData.task_type === exports.TaskType.TALK &&
                    requestData.taskMode !== exports.TaskMode.SYNC) {
    ...
    Object.defineProperty(StreamingAvatar.prototype, "isVoiceChatActive", {
        get: function () {
