...
var StreamingAvatar = (
  ...
  function() {
      ...
      return __awaiter(this, arguments, void 0, function(requestData) {
        ...
        return __generator(this, function(_d) {
          switch (_d.label) {
            ...
            case 1:
              _d.trys.push([1, 6, , 7]);
              return [4, this.loadAudioRawFrame()];
            case 2:
              _d.sent();
            ...
            case 4:
              ...
              this.scriptProcessor.onaudioprocess = function(event) {
                ...
                var frame = (_a2 = _this.audioRawFrame) === null || _a2 === void 0 ? void 0 : _a2.create({
                  audio: {
                ...
                var encodedFrame = new Uint8Array((_b2 = _this.audioRawFrame) === null || _b2 === void 0 ? void 0 : _b2.encode(frame).finish());
                (_c2 = _this.webSocket) === null || _c2 === void 0 ? void 0 : _c2.send(encodedFrame);
              };
              return [4, sleep(2e3)];
            case 5:
              _d.sent();
    ...
    Object.defineProperty(StreamingAvatar2.prototype, "isVoiceChatActive", {
      get: function() {
